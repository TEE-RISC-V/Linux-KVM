...
/*
 * Copies a page table recursively, and allocates new pages if necessary.
 */
...
/*
 * Transfer the initial page to HPT area.
 * Clears the table and flushes the TLB.
 */
...
// check if a page is in the hpt area
